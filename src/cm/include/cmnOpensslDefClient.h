...
typedef struct cmnOpensslFuncs
{
    ...
    void                 (*SSL_CTX_set_verify_depth)(SSL_CTX *aSsl, acp_sint32_t aDepth);
    ...
    acp_sint32_t         (*SSL_set_cipher_list)(SSL *aSsl, const acp_char_t *aStr);
    ...
    const acp_char_t*    (*OpenSSL_version)(acp_sint32_t aType);
} cmnOpensslFuncs;
